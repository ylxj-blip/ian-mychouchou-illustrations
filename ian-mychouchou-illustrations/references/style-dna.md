...
- 角色如果是臭臭猫，必须保留稳定识别锚点；这些锚点以已确认参考图和 `references/mychouchou-ip.md` 为准。
- 先看见臭臭猫在分析干活，再看见他可爱。
- 图像模型优先负责画结构和动作，复杂中文排版尽量交给后置排版工具。
- 臭臭猫整体仍然要偏简化卡通手绘，而不是偏写实宠物插画。
- 臭臭猫必须读得出是中长毛布偶猫：脸和尾巴之外，躯干也要有柔软蓬松感。
...
- 不要把臭臭猫画成宠物贴纸、Q 版吉祥物、卖萌头像或儿童角色。
- 不要把臭臭猫画成短毛猫躯干，或只有头尾像长毛猫。
- 不要把眼睛画成呆萌幼态圆眼、玻璃珠眼、空洞圆眼、狐狸细眼或写实猫眼。
- 不要把臭臭猫画成“先可爱、后分析干活”。
- 不要把臭臭猫画成胖墩、短腿团子或炸毛毛球。
...
- 系列图优先复用臭臭猫的脸部锚点、毛量比例、动作语法和低科技物件语法。
- 复用的是视觉语言，不是旧图构图。
