...
```text
Use $ian-mychouchou-illustrations 给这篇长文做配图策略。
...
```text
Use $ian-mychouchou-illustrations 为这个观点生成一张 16:9 正文配图：
...
```text
Use $ian-mychouchou-illustrations 为“把一条原始素材加工成流量、信任、转化三种内容”生成一张图。
不要画正式流程图，不要复刻一鱼多吃旧案例。
请重新发明一个新的低科技隐喻，让臭臭猫参与核心动作。
```
